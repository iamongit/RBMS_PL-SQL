...
public class GetSupply  extends JFrame
{
     ResultSet rs=null;
    ...
    public GetSupply () throws Exception
    {
         //Initializing frame       
        InitiateFrame();
    }
    ...
    void InitiateFrame() throws Exception{
        JFrame frame=new JFrame("Supply ");
    ...
    void getResultSet() throws Exception{
        ...
        //Prepare to call stored procedure:
         cs = Util.getDBConnection().prepareCall("begin ? := project2.get_supply(); end;");        
